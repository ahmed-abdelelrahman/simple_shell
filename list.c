...
/**
 * add_node_from_start - adds a node to the start of the list
 ...
 * Return: size of list
 */
list_t *add_node_from_start(list_t **head, const char *str, int num)
{
	list_t *new_head;
...
/**
 * free_list_nodes_mina - frees all nodes of a list
 * @head_ptr: address of pointer to head node
 *
 * Return: void
 */
void free_list_nodes_mina(list_t **head_ptr)
{
